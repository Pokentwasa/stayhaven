...
const SALT_HAVEN: Property = {
  ...
  gallery: [
    realMedia("GALLERY_01", "Round dining table with the kitchen and loft stairs beyond", "portrait", img("kitchen-dining-04.jpeg")),
    realMedia("GALLERY_02", "Closet with fresh linens, pillows and a throw blanket", "portrait", img("detail-04.jpeg")),
    realMedia("GALLERY_03", "A basket of board games for a night in", "landscape", img("family-02.jpeg")),
    realMedia("GALLERY_04", "Bathroom vanity tucked beneath the A-frame's sloped ceiling", "portrait", img("bathroom-02.jpeg")),
    realMedia("GALLERY_05", "Vaulted kitchen with marble counter and bar stools", "portrait", img("kitchen-dining-01.jpeg")),
    realMedia("GALLERY_06", "EV charger mounted under the carport", "landscape", img("detail-01.jpeg")),
    realMedia("GALLERY_07", "A bowl, treats and a blanket, ready for four-legged guests", "landscape", img("family-01.jpeg")),
    realMedia("GALLERY_08", "Bathroom vanity with a backlit mirror", "portrait", img("bathroom-04.jpeg")),
    realMedia("GALLERY_09", "Stove, microwave and coffee station", "landscape", img("kitchen-dining-08.jpeg")),
    realMedia("GALLERY_10", "Laundry supplies, stocked and ready", "portrait", img("detail-06.jpeg")),
    realMedia("GALLERY_11", "Glassware and dinnerware in the kitchen cabinet", "portrait", img("kitchen-dining-05.jpeg")),
    realMedia("GALLERY_12", "Bathroom with a walk-in shower", "portrait", img("bathroom-01.jpeg")),
    realMedia("GALLERY_13", "Pots, pans and cookware in the kitchen cabinet", "portrait", img("kitchen-dining-09.jpeg")),
    realMedia("GALLERY_14", "Books, vinyl and a record player on the media console", "landscape", img("detail-05.jpeg")),
    realMedia("GALLERY_15", "The fenced dog yard, welcome sign included", "landscape", img("family-03.jpeg")),
    realMedia("GALLERY_16", "Pantry basics — oil, spices and cookbooks", "portrait", img("kitchen-dining-06.jpeg")),
    realMedia("GALLERY_17", "Towels and a window nook in the bathroom", "landscape", img("bathroom-05.jpeg")),
    realMedia("GALLERY_18", "Kitchen utensil drawer", "landscape", img("kitchen-dining-07.jpeg")),
    realMedia("GALLERY_19", "A sign on the yard gate: no direct beach access", "portrait", img("detail-03.jpeg")),
    realMedia("GALLERY_20", "Under-sink bathroom storage, stocked with the essentials", "portrait", img("bathroom-03.jpeg")),
    realMedia("GALLERY_21", "Coffee and tea station", "landscape", img("kitchen-dining-10.jpeg")),
    realMedia("GALLERY_22", "Kitchen island, refrigerator and stairs to the loft", "landscape", img("kitchen-dining-03.jpeg")),
  ],
  rooms,
  amenities: AMENITIES,
  experiences: [
