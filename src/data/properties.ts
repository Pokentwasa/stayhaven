...
const SALT_HAVEN: Property = {
  ...
  gallery: [
    ...
    realMedia("GALLERY_04", "King bedroom with a private workspace and water view", "landscape", img("king-bedroom-01.jpeg")),
    realMedia("GALLERY_05", "A-frame exterior with Hood Canal and the Olympic Mountains behind", "landscape", img("exterior-03.jpeg")),
    realMedia("GALLERY_06", "Adirondack chairs around the propane fire pit, Hood Canal beyond", "landscape", img("fire-pit-01.jpeg")),
    realMedia("GALLERY_07", "The A-frame roofline seen across Hood Canal", "landscape", img("hood-canal-01.jpeg")),
    realMedia("GALLERY_08", "Dining table beneath the vaulted ceiling, Hood Canal beyond", "landscape", img("great-room-03.jpeg")),
    realMedia("GALLERY_09", "Kitchen island, refrigerator and stairs to the loft", "landscape", img("kitchen-dining-03.jpeg")),
    realMedia("GALLERY_10", "Queen bedroom opening onto the deck, Hood Canal beyond", "landscape", img("queen-bedroom-01.jpeg")),
    realMedia("GALLERY_11", "Loft with two twin beds beneath the A-frame's peak", "landscape", img("loft-01.jpeg")),
    realMedia("GALLERY_12", "Hot tub at sunset, overlooking Hood Canal", "landscape", img("hot-tub-02.jpeg")),
    ...
    realMedia("GALLERY_14", "Bedroom with in-room laundry and a walk-in closet", "landscape", img("king-bedroom-02.jpeg")),
    realMedia("GALLERY_15", "Record player and vinyl collection", "landscape", img("detail-02.jpeg")),
